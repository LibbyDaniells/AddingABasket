#Calibration of cut-off values under Method 1(a) where Delta is calibrated across scenarios
...
#Data Scenarios considered in the calibration
p1 <- c(q0,q0,q0,q0)
p2 <- c(q1,q0,q0,q0)
p3 <- c(q1,q1,q0,q0)
p4 <- c(q1,q1,q1,q0)
...
save(Method1Delta,file='Method1aDelta.RData')
