...
Method4aCalibration <- function(K1,K2,p,n,q0,run,pw){
  K <- K1+K2
  ...
  for(j in 1:run){
    ...
    Model.New <- EXNEX(pw,K,q0,n,no.successes)
    post_prob.Old <- apply(Model.Old,2,Fun)
    post_prob.New <- apply(Model.New,2,Fun)
    cut[j,] <- c(post_prob.Old,post_prob.New[(K1+1):K])
    print(j)
  }
...
Method4a <- function(K1,K2,run,n,p,q0,pw,cut.off.old,cut.off.new){
  K <- K1+K2
  no.successes <- rep(0,K)
  Fun <- function(x){
    fun <- sum(x>q0)/length(x)
  ...
  for(j in 1:run){
    ...
    point_estimates[j,(K1+1):K] <- round(colMeans(Model.New),3)[(K1+1):K]
    post_prob.Old <- apply(Model.Old,2,Fun)
    post_prob.New <- apply(Model.New,2,Fun)
...
pw <- 0.3
run <- 10000
# M4aDelta <- Method4aCalibration(K1,K2,p,n,q0,run,pw)
# 
# print(M4aDelta)
# save(M4aDelta,file='Method4a_Paper_Delta.RData')
...
# load('Method4a_Paper_Delta.RData')
# cut.off.old <- mean(M4aDelta[1:K1])
# cut.off.new <- mean(M4aDelta[(K1+1):(K)])

cut.off.old <- 0.8566457
cut.off.new <- 0.8409265
...
# Method4aSimulation <- c()
# for(i in 1:dim(pmat)[1]){
#   Simulation4a <- Method4a(K1,K2,run,n,pmat[i,],q0,pw,cut.off.old,cut.off.new)
#   Method4aSimulation <- cbind(Method4aSimulation,Simulation4a)
#   print(i)
# }
# Method4aSimulation
# save(Method4aSimulation,file='Method4a_Paper_Simulation.RData')


Sc1 <- Method4a(K1,K2,run,n,pmat[1,],q0,pw,cut.off.old,cut.off.new)
save(Sc1,file='Method4aScenario1.RData')
Sc2 <- Method4a(K1,K2,run,n,pmat[2,],q0,pw,cut.off.old,cut.off.new)
save(Sc2,file='Method4aScenario2.RData')
Sc3 <- Method4a(K1,K2,run,n,pmat[3,],q0,pw,cut.off.old,cut.off.new)
save(Sc3,file='Method4aScenario3.RData')
Sc4 <- Method4a(K1,K2,run,n,pmat[4,],q0,pw,cut.off.old,cut.off.new)
save(Sc4,file='Method4aScenario4.RData')
Sc5 <- Method4a(K1,K2,run,n,pmat[5,],q0,pw,cut.off.old,cut.off.new)
save(Sc5,file='Method4aScenario5.RData')
Sc6 <- Method4a(K1,K2,run,n,pmat[6,],q0,pw,cut.off.old,cut.off.new)
save(Sc6,file='Method4aScenario6.RData')
Sc7 <- Method4a(K1,K2,run,n,pmat[7,],q0,pw,cut.off.old,cut.off.new)
save(Sc7,file='Method4aScenario7.RData')
Sc8 <- Method4a(K1,K2,run,n,pmat[8,],q0,pw,cut.off.old,cut.off.new)
save(Sc8,file='Method4aScenario8.RData')
Sc9 <- Method4a(K1,K2,run,n,pmat[9,],q0,pw,cut.off.old,cut.off.new)
save(Sc9,file='Method4aScenario9.RData')
Sc10 <- Method4a(K1,K2,run,n,pmat[10,],q0,pw,cut.off.old,cut.off.new)
save(Sc10,file='Method4aScenario10.RData')
Sc11 <- Method4a(K1,K2,run,n,pmat[11,],q0,pw,cut.off.old,cut.off.new)
save(Sc11,file='Method4aScenario11.RData')
Sc12 <- Method4a(K1,K2,run,n,pmat[12,],q0,pw,cut.off.old,cut.off.new)
save(Sc12,file='Method4aScenario12.RData')
Sc13 <- Method4a(K1,K2,run,n,pmat[13,],q0,pw,cut.off.old,cut.off.new)
save(Sc13,file='Method4aScenario13.RData')
Sc14 <- Method4a(K1,K2,run,n,pmat[14,],q0,pw,cut.off.old,cut.off.new)
save(Sc14,file='Method4aScenario14.RData')
Sc15 <- Method4a(K1,K2,run,n,pmat[15,],q0,pw,cut.off.old,cut.off.new)
save(Sc15,file='Method4aScenario15.RData')
Sc16 <- Method4a(K1,K2,run,n,pmat[16,],q0,pw,cut.off.old,cut.off.new)
save(Sc16,file='Method4aScenario16.RData')

Method4a <- cbind(Sc1,Sc2,Sc3,Sc4,Sc5,Sc6,Sc7,Sc8,Sc9,Sc10,Sc11,Sc12,Sc13,Sc14,Sc15,Sc16)
save(Method4a,file='Method4aPaperSimulation.RData')
