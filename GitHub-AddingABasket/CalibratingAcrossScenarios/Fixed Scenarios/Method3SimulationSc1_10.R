...
cut.off <- c(rep(0.91011,K1),0.90211)
...
Method3 <- mclapply(list_scenarios,Method3a,K1,K2,run,n,q0,pw,cut.off,mc.cores=8)

save(Method3,file='Method3AcrossScenariosSimulation19.RData')