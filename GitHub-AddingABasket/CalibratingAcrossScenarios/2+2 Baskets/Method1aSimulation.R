...
Method1a <- function(p,K1,K2,run,n,q0,pw,cut.off.old,cut.off.new){
  K <- K1+K2
...
Method1 <- mclapply(list_scenarios,Method1a,K1,K2,run,n,q0,pw,cut.off.old,cut.off.new,mc.cores=10)

save(Method1,file='Method1AcrossScenariosSimulation2add2.RData')
