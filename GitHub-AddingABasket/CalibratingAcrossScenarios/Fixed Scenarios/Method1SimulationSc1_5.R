...
Method1 <- mclapply(list_scenarios,Method1a,K1,K2,run,n,q0,pw,cut.off.old,cut.off.new,mc.cores=8)

save(Method1,file='Method1AcrossScenariosSimulation15.RData')
