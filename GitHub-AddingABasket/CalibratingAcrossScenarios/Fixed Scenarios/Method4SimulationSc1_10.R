...
Method4 <- mclapply(list_scenarios,Method4a,K1,K2,run,n,q0,pw,cut.off.old,cut.off.new,mc.cores=16)

save(Method4,file='Method4AcrossScenariosSimulation19.RData')