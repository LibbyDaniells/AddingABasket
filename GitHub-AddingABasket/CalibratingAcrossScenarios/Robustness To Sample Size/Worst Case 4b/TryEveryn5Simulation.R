...
TryEveryn5 <- list()
for(i in 1:10){
  TryEveryn5[[i]] <- mclapply(nDelta_list,Method4b,pmat[i,],K1,K2,run,q0,pw,mc.cores=25)
}
save(TryEveryn5,file='TryEveryn5ValueSimMethod4.RData')


load('TryEveryn5ValueSimMethod4.RData')
