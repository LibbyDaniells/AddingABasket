#Finding cut-off values for posterior probabilities under Method 3 for each sample size n5=1 up to 24 (size of existing baskets)

#Calibrate cut-Offs across 1-10
