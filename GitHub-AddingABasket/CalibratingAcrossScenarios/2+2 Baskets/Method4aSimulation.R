#Simulation Study under Method 4(a) where we have E=2 existing and N=2 new baskets
...
Method4a <- function(p,K1,K2,run,n,q0,pw,cut.off.old,cut.off.new){
  K <- K1+K2
...
Method4 <- mclapply(list_scenarios,Method4a,K1,K2,run,n,q0,pw,cut.off.old,cut.off.new,mc.cores=10)

save(Method4,file='Method4AcrossScenariosSimulation152add2.RData')
