#Simulation Study under Method 2 where we have E=2 existing and N=2 new baskets
...
Method2 <- mclapply(list_scenarios,Method2,K1,K2,run,n,q0,pw,cut.off,mc.cores=10)

save(Method2,file='Method2AcrossScenariosSimulation2plus2.RData')
